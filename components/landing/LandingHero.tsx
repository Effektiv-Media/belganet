...
/**
 * Landing-page hero. The H1 is the page's LCP element, so it renders
 * visible in the server HTML — no fade-in entrance animation (which kept it
 * at opacity 0 until hydration) — and the background is an optimized,
 * preloaded next/image rather than a raw CSS background-image.
 */
export function LandingHero({
  ...
  return (
    ...
    >
      ...
      <ScrollButton
        targetId="lp-services"
        ariaLabel="Scrolla ned"
